<?php
	session_start();
	require_once 'classes/comentarios4.php';
	$c = new Comentario("projeto_comentarios","localhost","root","");
	$coments = $c->buscarComentarios4();
...
<div>
<img src="https://sp-ao.shortpixel.ai/client/to_webp,q_lossless,ret_img/https://senna.com/wp-content/uploads/2015/08/60KT_024-DIA-DA-INFANCIA-AYRTON-SENNA-860x430.jpg" alt="image" width="600" >
...
<div>
<img  src="https://s2-ge.glbimg.com/gk9_VCUigq9uEKLApQTID71gBcY=/0x0:2000x1414/984x0/smart/filters:strip_icc()/s.glbimg.com/es/ge/f/original/2014/04/26/81av_n006__a5_-_foto_familia_1.jpg" alt="image" width="500">
...
<div>
<img  src="https://senna.com/wp-content/uploads/2016/12/formula-3-1.jpg" alt="image" width="600">
...
<div>
<img  src="https://s2-ge.glbimg.com/6fpk4r_e3CssnmZuf-vhlW1qNRo=/0x0:600x349/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_bc8228b6673f488aa253bbcb03c80ec5/internal_photos/bs/2019/2/z/f3ewe7SLuQ3ztE3JMllg/c5m7bmtwqaer4kw.jpg" alt="image" width="600">
	...
	<h4 class="tol1"><span class="tol">Toleman 1985</span></h4>
...
<div>
<img  src="https://www.grandprix247.com/wp-content/uploads/2018/03/tmk0228fe27.jpg" alt="image" width="600">
	...
	<h4 class="lot1"><span class="lot">Lotus 1986-1987</span></h4>
...
<div>
<img  src="https://s2.glbimg.com/r8vAxWc670L49NOjLxRZKDQ5vrw=/0x0:699x400/690x395/s.glbimg.com/es/ge/f/original/2014/03/19/lotus_senna_1985_blog.jpg" alt="image" width="600">
...
<div>
<img  src="https://1.bp.blogspot.com/-StmfRI4KLJo/WG0F-ZvEwUI/AAAAAAAAM-Q/iDYdHRJIhCAEw0CCfb_H4umsfO3-TyUIwCLcB/s1600/espanha%2B1986%2B%25282%2529.jpg" alt="image" width="600">
...
<div>
<img  src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Lotus_99T_front-left_2012_Autosport_International.jpg" alt="image" width="400">

</div>

   <h4 class="mclr1"><span class="mclr">McLaren 1988-1993</span></h4>
...
<div>
<img  src="https://senna.com/wp-content/uploads/2016/12/japanese-1.jpg" alt="image" width="600">
...
<div>
<img  src="https://www.grandepremio.com.br/wp-content/uploads/2019/10/20194221344996_Imola_II.jpg" alt="image" width="600">
...
<div>
<img  src="https://www.rbsdirect.com.br/imagesrc/25410416.jpg?w=1200&h=630&a=c&version=1575255600" alt="image" width="600">
   ...
   <p class="texto">A temporada de 1990 reservou um momento inusitado na história da Fórmula 1. Em setembro daquele ano, durante o GP de Monza, na Itália, Senna fez uma 
...
<div>
<img  src="https://cdn-1.motorsport.com/static/img/amp/600000/640000/645000/645100/645167/s6_595214/f1-japanese-gp-1990-alain-prost-ferrari-and-ayrton-senna-mclaren-collide-in-the-first-corn.jpg" alt="image" width="600">
...
<div>
<img  src="https://start.youse.com.br/wp-content/uploads/2019/11/image_Easy-Resize.com-1.jpg" alt="image" width="600">
...
<div>
<img  src="https://www.razaoautomovel.com/wp-content/uploads/2022/01/mclambo-senna.jpeg" alt="image" width="500">

</div>

  <p class="texto">

  <h4 class="will1"><span class="will">Williams 1994</span></h4>
...
<div>
<img  src="https://s2-ge.glbimg.com/MpMQ06tMDchVvDibwhyy9sjn9b0=/0x15:1923x1304/984x0/smart/filters:strip_icc()/s.glbimg.com/es/ge/f/original/2014/11/05/1266942_1.jpg" alt="image" width="500">
  ...
  <div class="video-wrapper">
   ...
   <?php
		...
		<?php 	}else
				{ ?>
					<h2 id="comment">Deixe um comentário:</h2> <?php
				} 
			...
			<?php
				...
				{ ?>
					<form action="" method="POST">
						...
						<input type="submit" value="Publicar" name="btn-comentar">
					</form>
			<?php } 
						...
						<div class="area-comentario">
							...
							<h4><?php 
								 ...
								 if(isset($_SESSION['id_usuario']))
								 {
								 	...
								 	{ ?>
								 		<a href="ayrton.php?id_exc= <?php echo $v['id']; ?>">Excluir</a></h4>
							<?php 	}
